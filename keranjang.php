		...
		if (isset($_SESSION['user'])) {
			...
			if ($jml > 0) {
						...
						<tbody>
							<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
								...
								<tr>
									...
									<td style="color: black;">Rp.<?= number_format($row['hrg']); ?></td>
									<td><input type="number" name="qty" class="form-control" style="text-align: center;"
											value="<?= $row['jml']; ?>"></td>
									<td style="color: black;">Rp.<?= number_format($row['hrg'] * $row['jml']); ?></td>
									<td><button type="submit" name="submit1" class="btn btn-warning">Update</button> | <a
											href="keranjang.php?del=1&id=<?= $row['keranjang']; ?>" class="btn btn-danger"
				...
				?>
					...
					<tr>
						<td colspan="7" style="text-align: right; font-weight: bold;">Grand Total =
				...
				echo "
						...
						<tr>
						<td colspan='7' class='text-center bg-warning' style='color: black;'><h5><b>KERANJANG BELANJA ANDA KOSONG </b></h5></td>
						</tr>
